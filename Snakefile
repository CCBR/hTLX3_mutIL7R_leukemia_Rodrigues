...
rule integratedBatch:
	...
	output:
		rdsBatch=protected(join(workpath,"integration","seurat_batch_corrected","{myGroups}","{myGroups}.rds")),
		mergeRDS=protected(join(workpath,"integration","merged","{myGroups}","{myGroups}.rds")),
